...
public:
	...
	bool MsgBoxState;
	int MsgBoxType;
	DWORD MsgBoxCallback;
	DWORD MsgBoxCallBackArg1;
	DWORD MsgBoxCallBackArg2;
	void OpenMessageBox(char* caption, char* text, ...);
	void OpenMessageBoxOkCancel(DWORD callback, DWORD CallbackArg1, DWORD CallbackArg2, char* caption, char* text, ...);
	void DrawMessageBox();
