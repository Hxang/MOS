...
void cThueFlag::Draw()
{
	...
	if ( GetKeyState(VK_F24) & 0x4000 &&this->TickCount + 350 < GetTickCount())
	{
	...
	CustomFont.Draw(CustomFont.FontBold, x, y + 12, 0xffffffff, 0x0, w, 0, 3, "Hệ Thống Nâng Cấp Flag");
	...
	if (skin != 0)
	{
		...
		if (this->Selected <= skin->Value10)
		{
			...
			CustomFont.Draw(CustomFont.FontNormal, x + 4 + 75 * 2, y + 35, 0xffffffff, 0x0, 150, 0, 3, "Đã Kích Hoạt");
			CustomFont.Draw(CustomFont.FontNormal, x + 14 + 75 * 4, y + h - 62.5, 0xffffffff, 0x0, 73, 0, 3, skin->Skin != this->Skin ? "Sử Dụng" : "Không Sử Dụng");
		}
