...
public:
	...
	void        DrawToolTipKG(float x, float y, float w, float h, HFONT font, DWORD color, LPCSTR text, ...);
	void        DrawToolTipKG_bar(float x, float y, float w, float h, HFONT font, DWORD color, LPCSTR text, ...);
