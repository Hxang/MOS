...
CMinimap::CMinimap()
{
	...
	this->DataMap.YSW_Minimap = 310; //-- MiniMapY (Minimapa Arriba) (Mover Minimapa Arriba o Abajo)
	...
	this->ultimoY = 310;//Example of initial coordinate {Y}. Coordinate that will be constantly modified.
}
...
char CMinimap::MapRender(int a1)
{
	...
	//if (RoyalBattleGround.m_State >= 1 && pMapNumber == RoyalBattleGround.m_MapEvent)
	//{
	//	return 0;
	//}
	v44 = a1;
	...
	if (*(BYTE *)(a1 + 13500))
	{
		...
		float WHMinimap = 480;
		float RenderMapX = (MAX_WIN_WIDTH / 2) - (MainWidth / 2);
		float RenderMapY = (MAX_WIN_HEIGHT / 2) - (MainHeight / 2);
		...
		if (RoyalBattleGround.m_State >= 2 && pMapNumber == RoyalBattleGround.m_MapEvent)
		{
			...
			//pDrawBarForm((RenderMapX - 1) + (ViTriX* 1.6796875f), (RenderMapY +2) + ((ViTriY * 1.6796875f)- (RoyalBattleGround.zoneW * 1.6796875f)), (RoyalBattleGround.zoneW * 1.6796875f), (RoyalBattleGround.zoneH * 1.6796875f), 0, 0);
...
void CMinimap::AutoSendMove()
{
	...
	if (gObjUser.MoveToX != 0 && gObjUser.MoveToY != 0) {
		...
		CustomFont.Draw(FontTextMiniMap, (int)(MAX_WIN_WIDTH / 2) - (300 / 2), (int)30, 0xBBFF00FF, 0x0000008D, 300, 25, 3, "ĐANG DI CHUYỂN ĐẾN", *(DWORD *)0x81C038C, *(DWORD *)0x81C0388);
