...
struct Option
{
	unsigned __int32 opt_add : 2;	//??
	unsigned __int32 opt_luck : 1;	//幸运
	unsigned __int32 opt_level : 4;	//等级
	unsigned __int32 opt_skill : 1;	//技能
	unsigned __int32 opuunk : 24;	//追加
};
#pragma pack(push, 1)
...
struct MUChat
{
	...
	/*+312*/	DWORD	WindowHeight_; //ZEUS UP20
