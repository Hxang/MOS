...
BOOL CCustomJewel::CheckCustomJewelApplyItem(int ItemIndex, int TargetItemIndex) // OK
{
	...
	if (TargetItemIndex > GET_ITEM(12, 6) &&
		(TargetItemIndex < GET_ITEM(12, 36) || TargetItemIndex > GET_ITEM(12, 43))
		&& TargetItemIndex != GET_ITEM(12, 49) && TargetItemIndex != GET_ITEM(12, 50)
		&& (TargetItemIndex < GET_ITEM(12, 150) || TargetItemIndex > GET_ITEM(12, 300))
		&& TargetItemIndex != GET_ITEM(13, 30)

		&& TargetItemIndex != GET_ITEM(13, 8) && TargetItemIndex != GET_ITEM(13, 9)
		&& TargetItemIndex != GET_ITEM(13, 12) && TargetItemIndex != GET_ITEM(13, 13)
		&& (TargetItemIndex < GET_ITEM(13, 21) || TargetItemIndex > GET_ITEM(13, 28))
		&& (TargetItemIndex < GET_ITEM(13, 170) || TargetItemIndex > GET_ITEM(13, 199)) // Ring Pen

		&& (TargetItemIndex < GET_ITEM(13, 200) || TargetItemIndex > GET_ITEM(13, 300)) //Đạp Pet
