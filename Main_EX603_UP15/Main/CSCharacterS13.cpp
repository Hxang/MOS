...
{
	if (gProtect.m_MainInfo.CharRotate360 == 1)
	{
		for (int i = 0; i < 5; i++)
		{
...
void CSCharacterS13::SelectChar()
{
	...
	if (!*(BYTE *)((int)sub_482B70() + 33948))
	{
		...
		if (!*(BYTE *)(pGetPreviewStruct(pPreviewThis(), 0) + 780))
		{
			...
			gInterface.DrawFormat(eWhite180, X - 29, Y + 13, 210, 3, "Tạo thêm nhân vật");
		}
		//-- 1
		if (!*(BYTE *)(pGetPreviewStruct(pPreviewThis(), 1) + 780))
		{
			...
			gInterface.DrawFormat(eWhite180, X - 29, 88 + 13, 210, 3, "Tạo thêm nhân vật");
		}
		//-- 2
		if (!*(BYTE *)(pGetPreviewStruct(pPreviewThis(), 2) + 780))
		{
			...
			gInterface.DrawFormat(eWhite180, X - 29, 125 + 13, 210, 3, "Tạo thêm nhân vật");
		}
		//-- 3
		if (!*(BYTE *)(pGetPreviewStruct(pPreviewThis(), 3) + 780))
		{
			...
			gInterface.DrawFormat(eWhite180, X - 29, 162 + 13, 210, 3, "Tạo thêm nhân vật");
		}
		//-- 4
		if (!*(BYTE *)(pGetPreviewStruct(pPreviewThis(), 4) + 780))
		{
			...
			gInterface.DrawFormat(eWhite180, X - 29, 199 + 13, 210, 3, "Tạo thêm nhân vật");
		}
