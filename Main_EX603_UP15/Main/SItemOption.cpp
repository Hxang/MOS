...
int CSItemOption::InitSetOptionsTooltip(ObjectItem * lpItem, int CurrentLine, char a4)
{
	...
	//g_Console.AddMessage(3, "Item %d", (int)(lpItem->ExcellentOption));
...
int __thiscall CSItemOption::RenderDefaultOptionText(int This, ObjectItem* a2, int a3)
{
	if (a2->ItemID != -1)
	{
		...
		//for (int i = 0; i < (int)a2->SpecialCount; i++)
		//{
		//	switch (a2->SpecialType[i])
		//	{
		//	// opt 32
		//	case eItemOption::LifeIncrease:
		//		g_Console.AddMessage(1, pGetTextLine(pTextLineThis, 622));
		//		//pSetItemTextLine(Line, "Gia tang luong HP +%d%%",
		//		break;
		//	case eItemOption::ExcellentDamage:
		//		g_Console.AddMessage(1, pGetTextLine(pTextLineThis, 628));
		//		//pSetItemTextLine(Line, "Ty le sat thuong hoan hao +%d%%",
		//		break;
		//	// opt 16
		//	case eItemOption::ManaIncrease:
		//		g_Console.AddMessage(1, pGetTextLine(pTextLineThis, 623));
		//		//pSetItemTextLine(Line, "Gia tang luong Mana +%d%%",
		//		break;
		//	case eItemOption::DamageByLevel:
		//		g_Console.AddMessage(1, pGetTextLine(pTextLineThis, 629));
		//		//pSetItemTextLine(Line, "Gia tang cap do tan cong +Level/%d",
		//		break;
		//	case eItemOption::IncreaseWizardry: //Gay Phep
		//		g_Console.AddMessage(1, pGetTextLine(pTextLineThis, 631));
		//		//pSetItemTextLine(Line, "Gia tang cap do tan cong ( phep thuat ) +Level/%d",
		//		break;
		//	// opt 8
		//	case eItemOption::DamageDecrease: //Set Item
		//		g_Console.AddMessage(1, pGetTextLine(pTextLineThis, 624));
		//		//pSetItemTextLine(Line, "Giam suc sat thuong +%d%%",
		//		break;
		//	case eItemOption::IncreaseDamage: //==Vu Khi Vat Ly
		//		g_Console.AddMessage(1, pGetTextLine(pTextLineThis, 630), a2->SpecialValue[i]);
		//		//pSetItemTextLine(Line, "Gia tang suc sat thuong +%d%%",
		//		break;
		//	case eItemOption::IncreaseWizardryDmg: //==Vu Khi Phep
		//		g_Console.AddMessage(1, pGetTextLine(pTextLineThis, 632), a2->SpecialValue[i]);
		//		//pSetItemTextLine(Line, "Gia tang suc sat thuong phep thuat +%d%%",
		//		break;
		//	// opt 4
		//	case eItemOption::Reflect:
		//		g_Console.AddMessage(1, pGetTextLine(pTextLineThis, 625));
		//		//pSetItemTextLine(Line, "Phan hoi +%d%% luc sat thuong",
		//		break;
		//	case eItemOption::IncreaseSpeed:
		//		g_Console.AddMessage(1, pGetTextLine(pTextLineThis, 633), a2->SpecialValue[i]);
		//		//pSetItemTextLine(Line, "Gia tang toc do tan cong phep thuat +%d",
		//		break;
		//	// opt 2
		//	case eItemOption::DefenseSuccess:
		//		g_Console.AddMessage(1, pGetTextLine(pTextLineThis, 626));
		//		//pSetItemTextLine(Line, "Kha nang tranh don +%d%%",
		//		break;
		//	case eItemOption::LifePerMob:
		//		g_Console.AddMessage(1, pGetTextLine(pTextLineThis, 634));
		//		//pSetItemTextLine(Line, " Phuc hoi HP khi giet quai vat +HP/%d",
		//		break;
		//	// opt 1
		//	case eItemOption::IncreaseZen:
		//		g_Console.AddMessage(1, pGetTextLine(pTextLineThis, 627));
		//		//pSetItemTextLine(Line, "Tang luong Zen roi ra +%d%%",
		//		break;
		//	case eItemOption::ManaPerMob:
		//		g_Console.AddMessage(1, pGetTextLine(pTextLineThis, 635));
