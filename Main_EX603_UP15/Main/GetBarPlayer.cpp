...
void GetBitBarname(signed int a4, signed int a5, int a6)
{
	...
	if (a6 != -64 && *(BYTE *)(a6 + 64))
	{
		pDrawText(pTextThis(), v128 - 2, v129, (char *)(a6 + 64), v125 + 5, v130, (LPINT)3, 0);
		v129 += v130;
	}
	//-- InfoPlayer[Guild]
	if (a6 != -94 && *(BYTE *)(a6 + 94))
	{
		pDrawText(pTextThis(), v128 - 2, v129, (char *)(a6 + 94), v125 + 5, v130, (LPINT)3, 0);
		v129 += v130;
	}
	if (v127)
	{
...
#if (CUSTOM_NGUYENTOBB) // check logo ngu hanh
		int WChat = (*(WORD*)(*(DWORD*)(a6 + 668) + 124), 1);
	gElemental.ShowImgElemental(*(WORD*)(result + 0x7E), a4 + WChat + 1, a5);
#endif
	...
	{
		pSetFont(pTextThis(), (int)*(HGDIOBJ*)0xE8C58C);
		pDrawText(pTextThis(), v128 - 2, v129, (char *)a6, v125 + 5, v130, (LPINT)3, 0);
		v129 += v130;
		pSetFont(pTextThis(), (int)*(HGDIOBJ*)0xE8C588);
	}
	else
	...
	if (*(DWORD *)(a6 + 664) <= 0)
	{
		if (*(DWORD *)(a6 + 660) > 0)
		{
			...
			pDrawText(pTextThis(), v128 - 2, v129, (char *)(a6 + 148), v125 + 5, v130, (LPINT)3, 0);
		}
	}
	...
	else
	{
		...
		pDrawText(pTextThis(), v128 - 2, v129, (char *)(a6 + 404), v125 + 5, v130, (LPINT)3, 0);
		v129 += v130;
