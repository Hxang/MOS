...
DWORD PKEvent_TimeConLai = 0;
DWORD TvTEvent_TimeConLai = 0;

#if(CHIEN_TRUONG_CO)
//===ChienTruongCo
DWORD CTC_TimeConLai = 0;
DWORD CTC_PointKillQuai = 0;
DWORD CTC_PartyKillPoint = 0;
DWORD CTC_MonterYeuCau = 0;
DWORD CTC_QuaiVatDaKill = 0;
#endif
