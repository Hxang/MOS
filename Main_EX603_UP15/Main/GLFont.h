...
public:
	...
	//-- create text chat
	static void __thiscall SetFontChat(int thisa, HFONT hFont);
	static void __thiscall SetFontChatColorBG(int thisa, BYTE red, BYTE green, BYTE blue, BYTE alpha);
	static void __thiscall SetFontChatColorBG_Exp(int thisa, BYTE red, BYTE green, BYTE blue, BYTE alpha);
	//--
	//static void __thiscall SetFontColorWisper(int thisa, BYTE red, BYTE green, BYTE blue, BYTE alpha);
	//static void __thiscall SetFontColorParty(int thisa, BYTE red, BYTE green, BYTE blue, BYTE alpha);
	//static void __thiscall SetFontColorSystem(int thisa, BYTE red, BYTE green, BYTE blue, BYTE alpha);
	//static void __thiscall SetFontColorGuild(int thisa, BYTE red, BYTE green, BYTE blue, BYTE alpha);
	//static void __thiscall SetFontColorAlianza(int thisa, BYTE red, BYTE green, BYTE blue, BYTE alpha);
	//static void __thiscall SetFontColorGens(int thisa, BYTE red, BYTE green, BYTE blue, BYTE alpha);
	static int __thiscall CRenderTextChat(int thisa, int iPos_x, int iPos_y, LPCSTR pszText, int iBoxWidth, int iBoxHeight, int iSort, OUT SIZE* lpTextSize);
	static int __thiscall CRenderTextChatExp(int thisa, int iPos_x, int iPos_y, LPCSTR pszText, int iBoxWidth, int iBoxHeight, int iSort, OUT SIZE* lpTextSize);

	bool ShadowFlower;
	int typeshadow;
};

extern GLFont g_pRenderText;