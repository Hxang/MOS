...
enum eCustomArenaState
{
	...
	CUSTOM_ARENA_STATE_START = 3, //Vong Loai
	CUSTOM_ARENA_STATE_CHOBANKET = 4, //Vong Loai
	CUSTOM_ARENA_STATE_BANKET = 5, //BanKet
	CUSTOM_ARENA_STATE_CHOCHUNGKET = 6, //BanKet
	CUSTOM_ARENA_STATE_CHUNGKET = 7, //BanKet
	CUSTOM_ARENA_STATE_CLEAN = 8,
};
...
public:
	...
	void ProcState_CHOBANKET(CUSTOM_ARENA_INFO* lpInfo);
	void ProcState_BANKET(CUSTOM_ARENA_INFO* lpInfo);
	void ProcState_CHOCHUNGKET(CUSTOM_ARENA_INFO* lpInfo);
	void ProcState_CHUNGKET(CUSTOM_ARENA_INFO* lpInfo);
	...
	void SetState_CHOBANKET(CUSTOM_ARENA_INFO* lpInfo);
	void SetState_BANKET(CUSTOM_ARENA_INFO* lpInfo);
	void SetState_CHOCHUNGKET(CUSTOM_ARENA_INFO* lpInfo);
	void SetState_CHUNGKET(CUSTOM_ARENA_INFO* lpInfo);
	...
	int MapEvent[MAX_CUSTOM_ARENA];
	int IndexEventHienTai;
	void SendUserInfoEvent(CUSTOM_ARENA_INFO* lpInfo, int Clear = 0);
	//===Mess
	std::map<int, MESSAGE_INFO_DAUTRUONG> m_MessageInfoBP;
