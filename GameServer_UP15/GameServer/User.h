...
enum eInterfaceType
{
	...
	INTERFACE_DOIITEM = 21,
	INTERFACE_DATAOHOA = 22,
...
//----------
	...
	BYTE* InventoryMap1;
	BYTE* InventoryMap2;
	CEffect* EffectBackup;
	CSkill* MasterSkillBackup;
	...
	BYTE MSGProtect_Y;
	BYTE MSGProtect_MAP;
	DWORD MSGProtectMove_Time;
	DWORD MSGProtectAnimationTime;
...
int orderskill;
	...
	int   SAU_IndexMix;
	CItem SAU_ItemChinh;
	CItem SAU_ItemKetQua[6];
#endif

#if (CUSTOM_HARMONY)
	int	  SAUDATAO_IndexRandom;
	int   SAUTAOHOA_StatusMix;
	CItem SAUTAOHOA_ItemChuaEp;
	CItem SAUTAOHOA_ItemDaEp;
#endif
	...
	BYTE  CB_Status; //Trang Thai Event
	BYTE  CB_Status1; //Trang Thai Event
