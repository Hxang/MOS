...
public:
	...
	//bool SkillSwordPowerGetPhysiDamage(int aIndex, float* DamageMin, float* DamageMax);
	//bool SkillSwordPowerGetMagicDamage(int aIndex, float* DamageMin, float* DamageMax);
	//bool SkillSwordPowerGetCurseDamage(int aIndex, float* DamageMin, float* DamageMax);
