...
#pragma once
#define INVENTORY_WEAR_SIZE_CUSTOM gServerInfo.m_InventoryWearGetGift
#define INVENTORY_MAIN_SIZE_CUSTOM gServerInfo.m_InventoryMainGetGift
...
#define MAX_BUYSKIN_CB 300
class CInfoSkinBuy
{
public:
	CInfoSkinBuy();
	void AddListBuySkin(int SkinIndex);
	void Clear();
	bool IsBuy(int SkinIndex);
public:
	int SkinIndex;
	int StatusBuy;
	int CountSkinBuy;
