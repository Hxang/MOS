...
bool CCustomJewel::CheckCustomJewelApplyItem(int ItemIndex, CItem* lpItem) // OK
{
	...
	if (lpItem->m_Index > GET_ITEM(12, 6)
		...
		&& (lpItem->m_Index < GET_ITEM(12, 150) || lpItem->m_Index > GET_ITEM(12, 265))
		&& lpItem->m_Index != GET_ITEM(13, 30)
		//Ring Pen
		&& (lpItem->m_Index < GET_ITEM(13, 8) || lpItem->m_Index > GET_ITEM(13, 9))
		&& (lpItem->m_Index < GET_ITEM(13, 12) || lpItem->m_Index > GET_ITEM(13, 13))
		&& (lpItem->m_Index < GET_ITEM(13, 21) || lpItem->m_Index > GET_ITEM(13, 28))

		&& (lpItem->m_Index <= GET_ITEM(13, 170) && lpItem->m_Index >= GET_ITEM(13, 199)) //Ring Pen

		&& (lpItem->m_Index <= GET_ITEM(13, 200) && lpItem->m_Index >= GET_ITEM(13, 300)) //pet
																				...
																				if (lpItem->m_Index == GET_ITEM(13, 218)) // Pét Muun
																					if (lpItem->m_Index == GET_ITEM(13, 229)) // Pét Muun
																						if (lpItem->m_Index == GET_ITEM(13, 220)) // Pét Muun
																							if (lpItem->m_Index == GET_ITEM(13, 221)) // Pét Muun
																								if (lpItem->m_Index == GET_ITEM(13, 222)) // Pét Muun
																									if (lpItem->m_Index == GET_ITEM(13, 223)) // Pét Muun
																										if (lpItem->m_Index == GET_ITEM(13, 224)) // Pét Muun
																																										...
																																										if (lpItem->m_Index == GET_ITEM(13, 270)) //Ngựa
																																											...
																																											if (lpItem->m_Index == GET_ITEM(13, 271)) //Ngựa
																																												if (lpItem->m_Index == GET_ITEM(13, 272)) //Ngựa
																																													if (lpItem->m_Index == GET_ITEM(13, 273)) //Ngựa
																																														if (lpItem->m_Index == GET_ITEM(13, 274)) //Ngựa
																																															if (lpItem->m_Index == GET_ITEM(13, 275)) //Ngựa
																																																if (lpItem->m_Index == GET_ITEM(13, 276)) //Ngựa
																																																	if (lpItem->m_Index == GET_ITEM(13, 277)) //Ngựa
																																																		if (lpItem->m_Index == GET_ITEM(13, 278)) //Ngựa
																																																			if (lpItem->m_Index == GET_ITEM(13, 279)) //Ngựa
																																																				if (lpItem->m_Index == GET_ITEM(13, 280)) //Ngựa
																																																					if (lpItem->m_Index == GET_ITEM(13, 281)) //Ngựa
																																																						if (lpItem->m_Index == GET_ITEM(13, 282)) //Ngựa
																																																							if (lpItem->m_Index == GET_ITEM(13, 283)) //Ngựa
