...
void CEffectManager::InsertEffect(LPOBJ lpObj, CEffect* lpEffect) // OK
{
	...
	case EFFECT_GUILD_BUFF_1:
		lpObj->EffectOption.AddPhysiDamage += 10;
		lpObj->EffectOption.AddMagicDamage += 10;
		lpObj->EffectOption.AddCurseDamage += 10;
		lpObj->EffectOption.AddDefense += 1000;
		break;
	case EFFECT_GUILD_BUFF_2:
		lpObj->EffectOption.AddPhysiDamage += 20;
		lpObj->EffectOption.AddMagicDamage += 20;
		lpObj->EffectOption.AddCurseDamage += 20;
		lpObj->EffectOption.AddDefense += 2000;
		break;
	case EFFECT_GUILD_BUFF_3:
		lpObj->EffectOption.AddPhysiDamage += 30;
		lpObj->EffectOption.AddMagicDamage += 30;
		lpObj->EffectOption.AddCurseDamage += 30;
		lpObj->EffectOption.AddDefense += 3000;
		break;
	case EFFECT_GUILD_BUFF_4:
		lpObj->EffectOption.AddPhysiDamage += 40;
		lpObj->EffectOption.AddMagicDamage += 40;
		lpObj->EffectOption.AddCurseDamage += 40;
		lpObj->EffectOption.AddDefense += 4000;
		break;
	case EFFECT_GUILD_BUFF_5:
		lpObj->EffectOption.AddPhysiDamage += 50;
		lpObj->EffectOption.AddMagicDamage += 50;
		lpObj->EffectOption.AddCurseDamage += 50;
		lpObj->EffectOption.AddDefense += 5000;
		break;
