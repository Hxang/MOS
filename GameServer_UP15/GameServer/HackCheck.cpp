...
void InitHackCheck() // OK
{
	...
	EncDecKey1 = (BYTE)0xB2;
	EncDecKey2 = (BYTE)0x37; // Default is 0x76 [ ON THIS I MODIFIC THE 0x76 TO 0xFF ] BECAUSE THE PROBLEM DISCONNECT....
#else
	...
	if (MHPEncDecKey1 != 0 || MHPEncDecKey2 != 0)
	{
		...
		for (int n = 0; n < sizeof(gServerInfo.m_CustomerName); n++)
		{
			MHPEncDecKey += gServerInfo.m_CustomerName[n];
		}
