...
void CCashShop::MainProc() // OK
{
	...
	for (int n = OBJECT_START_USER; n < MAX_OBJECT; n++)
	{
		...
		/*if ((GetTickCount() - lpObj->CashShopGoblinPointTime) >= ((DWORD)gShopPointEx.m_TimeBonusInterval * 60000))
		{
		lpObj->CashShopGoblinPointTime = GetTickCount();
		gShopPointEx.AddTimeBonus(lpObj->Index);
...
void CCashShop::DGCashShopItemBuyRecv(SDHP_CASH_SHOP_ITEM_BUY_RECV* lpMsg) // OK
{
	...
	if (lpMsg->ProductMainIndex == 0)
	{
		...
		gLog.Output(LOG_CASH_SHOP, "[CashShopItemBuy][PackageInfo] Account:[%s] Name:[%s] - (Category: %d, BaseIndex: %d, MainIndex: %d, ItemIndex: %d, CoinIndex: %d, CoinValue: %d, BonusGP: %d)", lpObj->Account, lpObj->Name, lpPackageInfo->Category, lpPackageInfo->BaseIndex, lpPackageInfo->MainIndex, lpPackageInfo->ItemIndex, lpPackageInfo->CoinIndex, lpPackageInfo->CoinValue, lpPackageInfo->BonusGP);
...
void CCashShop::DGCashShopItemGifRecv(SDHP_CASH_SHOP_ITEM_GIF_RECV* lpMsg) // OK
{
	...
	if (lpMsg->ProductMainIndex == 0)
	{
		...
		for (int n = 0; n < MAX_CASH_SHOP_PACKAGE_PRODUCT; n++)
		{
			if (lpPackageInfo->ProductBaseIndex[n] != 0)
			{
				...
				gLog.Output(LOG_CASH_SHOP, "[CashShopItemGif][ProductInfo] Account:[%s] Name:[%s] - (BaseIndex: %d, MainIndex: %d, CoinValue: %d, ItemIndex: %d, ItemLevel: %d, ItemOption1: %d, ItemOption2: %d, ItemOption3: %d, ItemNewOption: %d, ItemSetOption: %d, ItemHarmonyOption: %d, ItemOptionEx: %d, ItemSocketOption: %d, %d, %d, %d, %d, ItemQuantity: %d, ItemDuration: %d)", lpObj->Account, lpObj->Name, lpProductInfo->BaseIndex, lpProductInfo->MainIndex, lpProductInfo->CoinValue, lpProductInfo->ItemIndex, lpProductInfo->ItemLevel, lpProductInfo->ItemOption1, lpProductInfo->ItemOption2, lpProductInfo->ItemOption3, lpProductInfo->ItemNewOption, lpProductInfo->ItemSetOption, lpProductInfo->ItemHarmonyOption, lpProductInfo->ItemOptionEx, lpProductInfo->ItemSocketOption1, lpProductInfo->ItemSocketOption2, lpProductInfo->ItemSocketOption3, lpProductInfo->ItemSocketOption4, lpProductInfo->ItemSocketOption5, lpProductInfo->ItemQuantity, lpProductInfo->ItemDuration);
			}
		}
	...
	else
	{
		...
		gLog.Output(LOG_CASH_SHOP, "[CashShopItemGif][PackageInfo] Account:[%s] Name:[%s] - (TargetAccount:%s, TargetName:%s, Category: %d, BaseIndex: %d, MainIndex: %d, ItemIndex: %d, CoinIndex: %d, CoinValue: %d, BonusGP: %d)", lpObj->Account, lpObj->Name, lpMsg->GiftAccount, lpMsg->GiftName, lpPackageInfo->Category, lpPackageInfo->BaseIndex, lpPackageInfo->MainIndex, lpPackageInfo->ItemIndex, lpPackageInfo->CoinIndex, lpPackageInfo->CoinValue, lpPackageInfo->BonusGP);
...
void CCashShop::DGCashShopItemUseRecv(SDHP_CASH_SHOP_ITEM_USE_RECV* lpMsg) // OK
{
	...
	gLog.Output(LOG_CASH_SHOP, "[CashShopItemUse][ProductInfo] Account:[%s] Name:[%s] - (BaseIndex: %d, MainIndex: %d, CoinValue: %d, ItemIndex: %d, ItemLevel: %d, ItemOption1: %d, ItemOption2: %d, ItemOption3: %d, ItemNewOption: %d, ItemSetOption: %d, ItemHarmonyOption: %d, ItemOptionEx: %d, ItemSocketOption: %d, %d, %d, %d, %d, ItemQuantity: %d, ItemDuration: %d)", lpObj->Account, lpObj->Name, lpProductInfo->BaseIndex, lpProductInfo->MainIndex, lpProductInfo->CoinValue, lpProductInfo->ItemIndex, lpProductInfo->ItemLevel, lpProductInfo->ItemOption1, lpProductInfo->ItemOption2, lpProductInfo->ItemOption3, lpProductInfo->ItemNewOption, lpProductInfo->ItemSetOption, lpProductInfo->ItemHarmonyOption, lpProductInfo->ItemOptionEx, lpProductInfo->ItemSocketOption1, lpProductInfo->ItemSocketOption2, lpProductInfo->ItemSocketOption3, lpProductInfo->ItemSocketOption4, lpProductInfo->ItemSocketOption5, lpProductInfo->ItemQuantity, lpProductInfo->ItemDuration);
...
void CCashShop::GDCashShopRecievePointSend(int aIndex, DWORD CallbackFunc, DWORD CallbackArg1, DWORD CallbackArg2) // OK
{
	...
	//====AAAAAA
	if ((GetTickCount() - gObj[aIndex].BPCashShopTime) < 1000)
	{
		LogAdd(LOG_RED, "[GDCashShopRecievePointSend] [%s][%s] Delay Bug Coin", gObj[aIndex].Account, gObj[aIndex].Name);
		return;
	}
