...
void JGConnectAccountRecv(SDHP_CONNECT_ACCOUNT_RECV* lpMsg) // OK
{
	...
	LogAddConnect(LOG_BLUE, "[Obj] [%d] Account (%s)", lpMsg->index, gObj[lpMsg->index].Account);
	gLog.Output(LOG_KET_NOI, "[Obj] [%d] Account (%s)", lpMsg->index, gObj[lpMsg->index].Account);
