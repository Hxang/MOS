...
void CMemoryAllocator::BindMemoryAllocatorInfo(int index, CMemoryAllocatorInfo MemoryAllocatorInfo) // OK
{
	...
	lpObj->EffectBackup = MemoryAllocatorInfo.m_EffectBackup;
	lpObj->MasterSkillBackup = MemoryAllocatorInfo.m_MasterSkillBackup;
...
#if(CBNEW_KHAMOPTION)
		lpObj->TradeInfoKham = MemoryAllocatorInfo.m_TradeInfoKham;
#endif
...
#endif
		lpObj->mInfoBuySkin = MemoryAllocatorInfo.m_mInfoBuySkin;
#if(JEWELBANKVER2)
		lpObj->BankJewelData = MemoryAllocatorInfo.m_BankJewelData;
#endif
	...
	else
	{
		...
		lpObj->EquipInventory1 = ((MemoryAllocatorInfo.m_EquipInventory1 == 0) ? this->m_TempMemoryAllocatorInfo.m_EquipInventory1 : MemoryAllocatorInfo.m_EquipInventory1); //ZEUS UP20
		lpObj->EquipInventory2 = ((MemoryAllocatorInfo.m_EquipInventory2 == 0) ? this->m_TempMemoryAllocatorInfo.m_EquipInventory2 : MemoryAllocatorInfo.m_EquipInventory2);
		lpObj->EquipInventoryMap1 = ((MemoryAllocatorInfo.m_EquipInventoryMap1 == 0) ? this->m_TempMemoryAllocatorInfo.m_EquipInventoryMap1 : MemoryAllocatorInfo.m_EquipInventoryMap1);
		lpObj->EquipInventoryMap2 = ((MemoryAllocatorInfo.m_EquipInventoryMap2 == 0) ? this->m_TempMemoryAllocatorInfo.m_EquipInventoryMap2 : MemoryAllocatorInfo.m_EquipInventoryMap2);
#endif
	}
}
