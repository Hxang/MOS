...
public:
	...
	int m_WriteResetLog;
	int m_WriteTienTeLog;
	int m_WriteKetNoiLog;
	int m_WriteThuMuaExcLog;
	...
	int SkillDocDW;
	int ThoiGianDameDocDW;

	int DameSkillSocGioDK;
	int SkillDamGioLan;

	//Event Get Gift Ran
	int m_InventoryWearGetGift;
	int m_InventoryMainGetGift;
	int m_NumBerGetGift;
