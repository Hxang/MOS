...
void CMemoryAllocatorInfo::Clear() // OK
{
	...
	this->m_HitDamage = 0;
	this->m_Effect = 0;
	this->m_EffectBackup = 0;
	this->m_MasterSkillBackup = 0;
...
#if(SLOTPET)
	this->m_EquipInventory1 = 0;
	this->m_EquipInventory2 = 0;
	this->m_EquipInventoryMap1 = 0;
	this->m_EquipInventoryMap2 = 0;
#endif
...
void CMemoryAllocatorInfo::Alloc() // OK
{
	...
	this->m_EffectBackup = new CEffect[MAX_EFFECT_LIST];
	...
	if(OBJECT_USER_RANGE(this->m_Index) != 0)
	{
		...
		this->m_MasterSkillBackup = new CSkill[MAX_MASTER_SKILL_LIST];
...
#endif
		this->m_mInfoBuySkin = new CInfoSkinBuy[MAX_BUYSKIN_CB];
#if(JEWELBANKVER2)
		this->m_BankJewelData = new USER_BANK_DATA[100];
#endif
		#if(GAMESERVER_UPDATE>=701)
