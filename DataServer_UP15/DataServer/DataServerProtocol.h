...
struct SDHP_RANKING_CUSTOM_GREATPK_SAVE_RECV
{
	PBMSG_HEAD header; // C1:55
	WORD index;
	char account[11];
...
struct SDHP_RANKING_BOS_SAVE_RECV
{
	PBMSG_HEAD header; // C1:3D
	WORD index;
	char account[11];
...
void GDRankingCustomGreatPKSaveRecv(SDHP_RANKING_CUSTOM_GREATPK_SAVE_RECV* lpMsg);
