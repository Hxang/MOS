...
CServerDisplayer::CServerDisplayer() // OK
{
	...
	//this->m_font1 = CreateFont(15, 0, 0, 0, FW_THIN, 0, 0, 0, VIETNAMESE_CHARSET, OUT_DEFAULT_PRECIS, CLIP_DEFAULT_PRECIS, DEFAULT_QUALITY, DEFAULT_PITCH | FF_DONTCARE, "Times");
	//this->m_font1 = CreateFont(15, 0, 0, 0, FW_THIN, 0, 0, 0, ANSI_CHARSET, OUT_DEFAULT_PRECIS, CLIP_DEFAULT_PRECIS, DEFAULT_QUALITY, DEFAULT_PITCH | FF_DONTCARE, "Times");
...
void CServerDisplayer::LogTextPaint() // OK
{
	...
	for(int n=0;n < MAX_LOG_TEXT_LINE;n++)
	{
		...
		//if (nn > 1)
		//{
		//	TextOutW(hdc, rect.left + 10, (rect.top + 5 + (line * 15)), CharUnicode, nn);
		//	line--;
		//}
