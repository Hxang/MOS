...
struct MAIN_FILE_INFO
{
	...
	DWORD EnableNutDonate;
	DWORD EnableNutSuKien;
	DWORD EnableNutThongTin;
...
int _tmain(int argc,_TCHAR* argv[]) // OK
{
	...
	info.EnableDKTK = GetPrivateProfileInt("Custom", "EnableDKTK", 0, ".\\MainInfo.ini");

	info.EnableNutDonate = GetPrivateProfileInt("Custom", "EnableNutDonate", 0, ".\\MainInfo.ini");

	info.EnableNutSuKien = GetPrivateProfileInt("Custom", "EnableNutSuKien", 0, ".\\MainInfo.ini");

	info.EnableNutThongTin = GetPrivateProfileInt("Custom", "EnableNutThongTin", 0, ".\\MainInfo.ini");
	...
	info.MenuButtons[5] = GetPrivateProfileInt("Custom","Bat_TreoOffline",0,".\\MainInfo.ini");
	...
	info.MenuButtons[10] = GetPrivateProfileInt("Custom", "Bat_QuanHam", 0, ".\\MainInfo.ini");

	info.MenuButtons[11] = GetPrivateProfileInt("Custom", "Bat_TuLuyen", 0, ".\\MainInfo.ini");

	info.MenuButtons[12] = GetPrivateProfileInt("Custom", "Bat_SkinModel", 0, ".\\MainInfo.ini");

	info.MenuButtons[13] = GetPrivateProfileInt("Custom", "Bat_HonHoan", 0, ".\\MainInfo.ini");

	info.MenuButtons[14] = GetPrivateProfileInt("Custom", "Bat_MuaFlag", 0, ".\\MainInfo.ini");

	info.MenuButtons[15] = GetPrivateProfileInt("Custom", "Bat_DoiReset", 0, ".\\MainInfo.ini");

	info.MenuButtons[16] = GetPrivateProfileInt("Custom", "Bat_MocNap", 0, ".\\MainInfo.ini");
	...
	info.CharRotate360 = GetPrivateProfileInt("UPGRADE", "CharRotate360 ", 0, ".\\MainInfo.ini");
...
//-----
	...
	if (CRC32.FileCRC("SharkGuard.doc", &VerifyDllCRC, 1024) == 0)
	{
		VerifyDllCRC = 0;
	}
	...
	fout << "SharkGuardDllCRC = 0x" << std::hex << (DWORD)info.HackCRC32 << std::endl;
